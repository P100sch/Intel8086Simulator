...
for i in "${listings[@]}"
do
  "go" run "./scripts/convertHomeWorkOutput.go" "https://raw.githubusercontent.com/cmuratori/computer_enhance/refs/heads/main/perfaware/part1/$i" "./tests/data/simulation/outputs/$i"
done